                    ...
                    <div className="semesters">
                        ...
                        >
                            ...
                            {visibleSections.semII && (
                                <div className="subjects">
                                    <div>
                                        <Link to="/Web Technology/labList">
                                            Web Technology
                                        </Link>
                                    </div>
                                    <Link to="RDBMS/labList">
                                        Relation Database
                                    </Link>
                                </div>
                            )}
                        ...
                        >
                            ...
                            {visibleSections.semIII && (
                                <div className="subjects">
                                    <div>
                                        {" "}
                                        <Link to="Data Structure/labList">
                                            Data Structure
                                        </Link>
                                    </div>
                                    <div>
                                        {" "}
                                        <Link to="/Big Data/labList">
                                            Big Data
                                        </Link>
                                    </div>
                                    <div>
                        ...
                        >
                            ...
                            {visibleSections.semIV && (
                                <div className="subjects">
                                    ...
                                    <div>
                                        {" "}
                                        <Link to="/Advance Php/labList">
                                            Advance Php
                                        </Link>
                                    </div>
                                    <div>
                                        <Link to="/Node JS/labList">
                                            Node JS
                                        </Link>
                                    </div>
                                </div>
