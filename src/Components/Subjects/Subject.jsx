...
function Subject({ subRoute, subName }) {
  return (
    ...
    >
      <div className="flex flex-col h-44 w-32 bg-accent shadow-even-shadow hover:shadow-accent  rounded-custom  text-center ">
        <img
          src=""
          alt="sub logo"
          className="w-full h-[70%] object-cover bg-white rounded-t-custom"
        />
        <h3 className="font-bold text-white text-center h-[40%] p-2">
          {subName}
        </h3>
      </div>
    </Link>
