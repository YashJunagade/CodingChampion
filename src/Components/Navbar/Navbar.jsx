  ...
  return (
    <div className="relative z-40">
      <motion.nav
        ...
        className="w-full h-14 md:h-16 bg-offWhite dark:bg-black dark:text-white text-black flex justify-between items-center px-4 md:px-6 md:fixed top-0 left-0 right-0"
      >
        <div>
          <img src="" alt="logo" />
        </div>
